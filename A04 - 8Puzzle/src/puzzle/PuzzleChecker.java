...
public class PuzzleChecker {
    ...
    public static void main(String[] args) {
		String file = "src/puzzle/puzzle05.txt";
//		String file1 = "src/puzzle/puzzle4x4-48.txt";
//		String file2 = "src/puzzle/puzzle3x3-00.txt";
		String file3 = "src/puzzle/puzzle3x3-31.txt";
		String file4 = "src/puzzle/puzzle3x3-03.txt";
		String file5 = "src/puzzle/puzzle4x4-unsolvable.txt";
		String[] files = {file3};
